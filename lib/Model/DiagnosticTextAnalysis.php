...
/**
 * DiagnosticTextAnalysis Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class DiagnosticTextAnalysis implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DiagnosticTextAnalysis';
     ...
     * Sets explanation
     *
     * @param string|null $explanation Explanatory text (used in summary and reason)
     *
     * @return self
     */
