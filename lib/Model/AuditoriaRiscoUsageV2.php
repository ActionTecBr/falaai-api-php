...
/**
 * AuditoriaRiscoUsageV2 Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class AuditoriaRiscoUsageV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuditoriaRiscoUsageV2';
     ...
     * Sets characters
     *
     * @param int $characters Characters analyzed
     *
     * @return self
     */
     ...
     *
     * @param int $credits_consumed Credits consumed
     *
     * @return self
     */
     ...
     * Sets processing_ms
     *
     * @param int $processing_ms Processing time (ms)
     *
     * @return self
     */
