...
/**
 * CreateEmailAlertRequest Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class CreateEmailAlertRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateEmailAlertRequest';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'email' => 'string',
        'events' => '\FalaAI\Model\EmailEvent[]'
    ];
     ...
     * Gets events
     *
     * @return \FalaAI\Model\EmailEvent[]
     */
     ...
     * Sets events
     *
     * @param \FalaAI\Model\EmailEvent[] $events Eventos subscritos
     *
     * @return self
     */
