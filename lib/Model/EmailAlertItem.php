...
/**
 * EmailAlertItem Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class EmailAlertItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailAlertItem';
     ...
     * Sets id
     *
     * @param string $id Email alert id
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Email alert name
     *
     * @return self
     */
