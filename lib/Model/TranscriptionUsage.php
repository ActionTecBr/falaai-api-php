...
/**
 * TranscriptionUsage Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class TranscriptionUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TranscriptionUsage';
    ...
    {
        $this->setIfExists('audio_seconds', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['audio_seconds'] === null) {
            $invalidProperties[] = "'audio_seconds' can't be null";
        }
     ...
     * @return float
     */
    public function getAudioSeconds()
    {
        return $this->container['audio_seconds'];
    }

    /**
     * Sets audio_seconds
     *
     * @param float $audio_seconds Actual audio duration processed in seconds
     *
     * @return self
     */
    public function setAudioSeconds($audio_seconds)
    {
        if (is_null($audio_seconds)) {
            throw new \InvalidArgumentException('non-nullable audio_seconds cannot be null');
        }
        $this->container['audio_seconds'] = $audio_seconds;
     ...
     *
     * @param int $credits_consumed Number of credits consumed in this request
     *
     * @return self
     */
