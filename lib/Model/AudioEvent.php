 ...
 */
class AudioEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AudioEvent';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['start_s'] === null) {
            $invalidProperties[] = "'start_s' can't be null";
        }
        if ($this->container['end_s'] === null) {
            $invalidProperties[] = "'end_s' can't be null";
        }
        if ($this->container['duration_s'] === null) {
            $invalidProperties[] = "'duration_s' can't be null";
        }
        if ($this->container['formatted_timestamp'] === null) {
            $invalidProperties[] = "'formatted_timestamp' can't be null";
        }
     ...
     * Sets event
     *
     * @param string $event Type of identified audio event. Ex: [riso], [suspiro], [pausa], [tosse]
     *
     * @return self
     */
     ...
     * Sets start_s
     *
     * @param float $start_s Start time of audio event in seconds
     *
     * @return self
     */
     ...
     * Sets end_s
     *
     * @param float $end_s End time of audio event in seconds
     *
     * @return self
     */
     ...
     * Sets duration_s
     *
     * @param float $duration_s Event duration in seconds
     *
     * @return self
     */
     ...
     *
     * @param string $formatted_timestamp Formatted timestamp HH:MM:SS.mmm of event start
     *
     * @return self
     */
