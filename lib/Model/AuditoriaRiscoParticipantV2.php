...
/**
 * AuditoriaRiscoParticipantV2 Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class AuditoriaRiscoParticipantV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuditoriaRiscoParticipantV2';
     ...
     * Sets interlocutor
     *
     * @param string|null $interlocutor Speaker label
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Participant name
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role Role (agent/client/bot/unknown)
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param string|null $confidence Role inference confidence (high/medium/low)
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Role source (input/inferred)
     *
     * @return self
     */
     ...
     * Sets evidence
     *
     * @param string|null $evidence Role inference evidence
     *
     * @return self
     */
