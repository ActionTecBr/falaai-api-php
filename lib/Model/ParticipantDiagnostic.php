...
/**
 * ParticipantDiagnostic Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class ParticipantDiagnostic implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ParticipantDiagnostic';
     ...
     * Sets interlocutor
     *
     * @param string $interlocutor Exact speaker label from the dialog (e.g. 'Speaker 1')
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string $role Role: agent | client | bot | agent_requester | agent_custodian
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Participant name if mentioned in the dialogue
     *
     * @return self
     */
     ...
     * Sets confidence
     *
     * @param string|null $confidence high | medium | low
     *
     * @return self
     */
     ...
     * Sets evidence
     *
     * @param string|null $evidence Exact verbatim quote supporting the role (no timestamps)
     *
     * @return self
     */
