...
/**
 * AuditoriaRiscoAudioEventModelV2 Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class AuditoriaRiscoAudioEventModelV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuditoriaRiscoAudioEventModelV2';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('windows_s', $data ?? [], null);
    }
     ...
     * Sets model
     *
     * @param string|null $model MAC model text (i18n)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description MAC description (i18n)
     *
     * @return self
     */
     ...
     */
    public function getWindowsS()
    {
        return $this->container['windows_s'];
    }

    /**
     * Sets windows_s
     *
     * @param array<string,mixed>|null $windows_s Temporal windows (s)
     *
     * @return self
     */
    public function setWindowsS($windows_s)
    {
        if (is_null($windows_s)) {
            throw new \InvalidArgumentException('non-nullable windows_s cannot be null');
        }
        $this->container['windows_s'] = $windows_s;
