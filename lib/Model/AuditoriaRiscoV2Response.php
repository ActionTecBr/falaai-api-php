...
/**
 * AuditoriaRiscoV2Response Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class AuditoriaRiscoV2Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuditoriaRiscoV2Response';
    ...
    protected static $openAPITypes = [
        'response' => '\FalaAI\Model\AuditoriaRiscoV2'
    ];
     ...
     * Gets response
     *
     * @return \FalaAI\Model\AuditoriaRiscoV2
     */
     ...
     * Sets response
     *
     * @param \FalaAI\Model\AuditoriaRiscoV2 $response Public response V2 â€” always returned
     *
     * @return self
     */
