...
/**
 * DiagnosticUsage Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class DiagnosticUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DiagnosticUsage';
     ...
     * Sets characters
     *
     * @param int $characters Total characters analyzed
     *
     * @return self
     */
     ...
     *
     * @param int $credits_consumed Credits consumed: max(ceil(chars/500)*3, 3) * 5
     *
     * @return self
     */
