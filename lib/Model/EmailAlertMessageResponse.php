...
/**
 * EmailAlertMessageResponse Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class EmailAlertMessageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailAlertMessageResponse';
     ...
     * Sets message
     *
     * @param string $message Operation result message
     *
     * @return self
     */
