...
class CreateWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'url' => 'string',
        'events' => '\FalaAI\Model\WebhookEvent[]',
        'retry_enabled' => 'bool'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('retry_enabled', $data ?? [], false);
    }
     ...
     * Sets name
     *
     * @param string $name Nome identificador do webhook
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url URL HTTPS que recebera POST com HMAC FalaAI-Signature
     *
     * @return self
     */
     ...
     * Gets events
     *
     * @return \FalaAI\Model\WebhookEvent[]
     */
     ...
     * Sets events
     *
     * @param \FalaAI\Model\WebhookEvent[] $events Eventos subscritos (10 alertas)
     *
     * @return self
     */
     ...
     * Sets retry_enabled
     *
     * @param bool|null $retry_enabled Retry exponencial 5 tentativas quando true (false=1 tentativa)
     *
     * @return self
     */
