...
/**
 * AuditoriaRiscoScoresV2 Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class AuditoriaRiscoScoresV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuditoriaRiscoScoresV2';
    ...
    protected static $openAPITypes = [
        'conversation' => '\FalaAI\Model\AuditoriaRiscoConversationScoresV2',
        'per_participant' => 'array<string,mixed>'
    ];
    ...
    protected static $setters = [
        ...
        'per_participant' => 'setPerParticipant'
    ];
    ...
    protected static $getters = [
        ...
        'per_participant' => 'getPerParticipant'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('per_participant', $data ?? [], null);
    }
     ...
     * Gets conversation
     *
     * @return \FalaAI\Model\AuditoriaRiscoConversationScoresV2
     */
     ...
     * Sets conversation
     *
     * @param \FalaAI\Model\AuditoriaRiscoConversationScoresV2 $conversation Conversation scores
     *
     * @return self
     */
    ...
    /**
     * Gets per_participant
     *
     * @return array<string,mixed>|null
     */
    public function getPerParticipant()
    {
        return $this->container['per_participant'];
    }

    /**
     * Sets per_participant
     *
     * @param array<string,mixed>|null $per_participant Per-participant KPIs
     *
     * @return self
     */
    public function setPerParticipant($per_participant)
    {
        if (is_null($per_participant)) {
            throw new \InvalidArgumentException('non-nullable per_participant cannot be null');
        }
        $this->container['per_participant'] = $per_participant;
