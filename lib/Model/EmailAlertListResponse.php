...
/**
 * EmailAlertListResponse Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class EmailAlertListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailAlertListResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\FalaAI\Model\EmailAlertItem[]',
        'page' => 'int',
        'limit' => 'int'
    ];
     ...
     * Gets data
     *
     * @return \FalaAI\Model\EmailAlertItem[]
     */
     ...
     * Sets data
     *
     * @param \FalaAI\Model\EmailAlertItem[] $data data
     *
     * @return self
     */
