...
/**
 * DiagnosticCategoricalAnalysis Class Doc Comment
 *
 * @category Class
 * @package  FalaAI
 * @author   OpenAPI Generator team
 ...
 */
class DiagnosticCategoricalAnalysis implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DiagnosticCategoricalAnalysis';
    ...
    protected static $setters = [
        'list_choice' => 'setListChoice',
        'justification' => 'setJustification',
        'evidence_phrases' => 'setEvidencePhrases'
    ];
    ...
    protected static $getters = [
        'list_choice' => 'getListChoice',
        'justification' => 'getJustification',
        'evidence_phrases' => 'getEvidencePhrases'
    ];
    ...
    {
        $this->setIfExists('list_choice', $data ?? [], null);
        $this->setIfExists('justification', $data ?? [], null);
        $this->setIfExists('evidence_phrases', $data ?? [], null);
    }
    ...
    {
        return $this->container['list_choice'];
    }

    /**
     * Sets list_choice
     *
     * @param string|null $list_choice Selected value from classification list (used in action, label, sentiment)
     *
     * @return self
     */
    public function setListChoice($list_choice)
    {
        if (is_null($list_choice)) {
            throw new \InvalidArgumentException('non-nullable list_choice cannot be null');
        }
        $this->container['list_choice'] = $list_choice;
     ...
     * Sets justification
     *
     * @param string|null $justification Justification for the choice
     *
     * @return self
     */
    ...
    /**
     * Gets evidence_phrases
     *
     * @return string[]|null
     */
    public function getEvidencePhrases()
    {
        return $this->container['evidence_phrases'];
    }

    /**
     * Sets evidence_phrases
     *
     * @param string[]|null $evidence_phrases Verbatim transcript excerpts supporting the analysis
     *
     * @return self
     */
    public function setEvidencePhrases($evidence_phrases)
    {
        if (is_null($evidence_phrases)) {
            throw new \InvalidArgumentException('non-nullable evidence_phrases cannot be null');
        }
        $this->container['evidence_phrases'] = $evidence_phrases;
