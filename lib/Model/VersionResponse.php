...
class VersionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deploy_date', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deploy_date'] === null) {
            $invalidProperties[] = "'deploy_date' can't be null";
        }
     ...
     * Sets deploy_date
     *
     * @param string $deploy_date Deploy timestamp
     *
     * @return self
     */
    public function setDeployDate($deploy_date)
    {
        if (is_null($deploy_date)) {
            throw new \InvalidArgumentException('non-nullable deploy_date cannot be null');
        }
