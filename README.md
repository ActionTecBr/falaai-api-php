# FalaAI API PHP SDK - Speech-to-Text, Call Analytics & Compliance Audit

[![version](https://img.shields.io/packagist/v/actiontecbr/falaai-api)](https://packagist.org/packages/actiontecbr/falaai-api)
...
Official PHP SDK for the **FalaAI API** - call transcription, conversation intelligence and compliance auditing (**COPC CX**, **ISO 18295-1**).
...
WordPress / WooCommerce - SuiteCRM - Vtiger - Bitrix24 (self-hosted) - Perfex - FreePBX / Asterisk - RD Station - Meetime
